(*
	Fichero: Unidad8_2 modificado.pas
	Fecha: 16/05/2019
	Autor: Daniel García Zambrano
	Mail: metroid.xdan@gmail.com
	Descripción: Almacena información sobre compras de productos y la muestra por pantalla. No contiene el problema descrito en la hoja de ejercicios.
	*)
...
begin
	...
	for i:= 1 to tammaxcesta do
	begin
		if (entrada[i].nombre = nombreprod) and entrada[i].en_cesta then
			idproducto := i;
	end
end;
...
(*Procedimiento modificar_producto: busca un producto por su nombre y, si lo encuentra, cambia una variable a decisión del usuario.*)
