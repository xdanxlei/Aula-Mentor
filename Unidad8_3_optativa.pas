(*
	Fichero: Unidad8_3_optativa.pas
	Fecha: 17/05/2019
	Autor: Daniel García Zambrano
	Mail: metroid.xdan@gmail.com
	Descripción: recoge los datos de tres cuadros y los muestra por pantalla junto a la suma de sus precios.
	*)

Program Unidad8_3_optativa;
